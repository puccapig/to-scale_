#Rachel Yuan Nong Mikkelsen 2022-JANUARY-02
#Or any sequence from a plain txt file

or_any_sequence <- function(){
	...
	print("read sequence by [...]nt footstep:")
	footstep <- readline()
	footstep <- as.numeric(footstep)
